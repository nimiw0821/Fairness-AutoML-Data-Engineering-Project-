...
class FairAutoML():
    ...
    def fit(self, dataset, dataset_metric, dataset_metric_threshold,
        ...
        if not self.no_postproc: # if post-processing is needed
            ...
            # train autosklearn with lfr b/c it has less requirement and strong power. 
            # Then use autosklearn to fit train and transform val. Then perform postproc on predicted val. Check fairness of val.
            # Then use these preproc, classifier and postproc on test.
